...
public class MostrarHistorialClínicoBDVacia extends javax.swing.JFrame 
{

    public MostrarHistorialClínicoBDVacia() 
    {
        initComponents();
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, -1, 530));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MostrarHistorialClínicoBDVacia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MostrarHistorialClínicoBDVacia().setVisible(true);
            }
        });
    }
