...
public class ReporteCitasMédicasPorFechaBDVacia extends javax.swing.JFrame 
{
    public ReporteCitasMédicasPorFechaBDVacia() 
    {
        initComponents();
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1200, 560));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReporteCitasMédicasPorFechaBDVacia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ReporteCitasMédicasPorFechaBDVacia().setVisible(true);
            }
        });
    }
