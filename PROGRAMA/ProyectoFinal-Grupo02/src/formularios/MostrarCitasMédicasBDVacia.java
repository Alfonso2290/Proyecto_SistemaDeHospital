...
public class MostrarCitasMédicasBDVacia extends javax.swing.JFrame {

    public MostrarCitasMédicasBDVacia() 
    {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MostrarCitasMédicasBDVacia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MostrarCitasMédicasBDVacia().setVisible(true);
            }
        });
    }
