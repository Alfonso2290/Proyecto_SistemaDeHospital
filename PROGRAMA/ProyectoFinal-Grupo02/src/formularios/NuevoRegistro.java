...
public class NuevoRegistro extends javax.swing.JFrame
{
    ...
    public NuevoRegistro() 
    {
        ...
        setTitle("Registro de Cuenta de Usuario");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Registro de Cuenta de Usuario");
        ...
        jLabel113.setText("Nombre de Cuenta:");

        jLabel24.setFont(new java.awt.Font("Consolas", 1, 14)); // NOI18N
        jLabel24.setText("Tipo de Usuario:");

        cbTipo.setFont(new java.awt.Font("Consolas", 0, 12)); // NOI18N
        cbTipo.setForeground(new java.awt.Color(0, 0, 153));
        cbTipo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "--Seleccionar--", "master", "comun" }));

        lblfoto.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 3));

        btnAgregarImagen.setFont(new java.awt.Font("Consolas", 1, 14)); // NOI18N
        ...
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1040, 570));
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        String nom,appa,apma,dni,email,tefi,temo,fereg,femod,cargo,sexo,calle,distrito,departamento,cuenta,cont,tipo;
        int ext,inte,idcalle=0,iddepart=0,iddistri=0,maxidempleado=0;
        ...
        try
        {
            ...
            ResultSet tabla1=instruccion.executeQuery("select max(id_empleado) from empleados order by id_empleado");
            if(tabla1.next())
            {
                maxidempleado=tabla1.getInt("max(id_empleado)");
            }
            ...
            instruccion.executeUpdate("INSERT INTO usuario(refid_empleado,nombre_usuario,clave_usuario, tipo_usuario,fechaingreso_usuario,fechamodificacion_usuario) VALUES ("
                                +  maxidempleado + ",'" + cuenta + "','" + cont + "','" + tipo + "','" + fereg + "','" + femod + "')" );
