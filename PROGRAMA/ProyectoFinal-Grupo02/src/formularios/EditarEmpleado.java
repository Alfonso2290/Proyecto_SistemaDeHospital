...
public class EditarEmpleado extends javax.swing.JFrame 
{
    ...
    private void initComponents() {
        ...
        calFereg = new com.toedter.calendar.JDateChooser();
        ...
        jLabel1.setText("Edición de Empleado");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                            ...
                            .addComponent(calFereg, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(txtInt, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 132, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(txtExt, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 131, javax.swing.GroupLayout.PREFERRED_SIZE)))))))
                .addGap(60, 60, 60)
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    ...
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        .addComponent(calFereg, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addGap(3, 3, 3))))
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGap(18, 18, 18)
        ...
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 990, 530));
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        try
        {
            ...
            String sql="update empleados set nombres_empleado=?,apellpat_empleado=?,apellmat_empleado=?,dni_empleado=?," + 
                        "telfijo_empleado=?,telmovil_empleado=?,sexo_empleado=?,email_empleado=?,cargo_empleado=?,fechareg_empleado=?,"
                        +  "fechamodi_empleado=?, numext_empleado=?,numint_empleado=?,refid_departamento=?,refid_distrito=?," + 
                        "refid_calle=?,foto_empleado=? where id_empleado=" + idempleado;
            ...
            inst.setInt(12,ext);
            inst.setInt(13,inte);
            inst.setInt(14,iddepart);
            inst.setInt(15,iddistri);
            inst.setInt(16,idcalle);
            inst.setBinaryStream(17,file,longitudBytes);

            inst.execute();
            
            JOptionPane.showMessageDialog(null,"==> Se ha actualizado los datos del empleado correctamente <==");
        }
        catch(SQLException e)
        {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditarEmpleado(idempleado).setVisible(true);
            }
        });
    }
    ...
    public com.toedter.calendar.JDateChooser calFereg;
